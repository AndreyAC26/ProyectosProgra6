...
namespace LogicaNegocio.Implementacion
{
    public class CountryRegionLN : ICountryRegionLN
    {
        ...
        public List<CountryRegion> recCountryRegion_ENT()
        {
            ...
            try
            {
                lobRespuesta = gobjCountryRegionAD.recCountryRegion_ENT();
            }
            catch (Exception lEX) 
            {
        ...
        public bool modCountryRegion_ENT(CountryRegion pCountryRegion)
        {
            ...
            try
            {
               lobjRespuesta = gobjCountryRegionAD.modCountryRegion_ENT((CountryRegion)pCountryRegion);
            }
            catch (Exception lEx)
            {
        ...
        public bool delCountryRegion_ENT(CountryRegion pCountryRegion)
        {
            ...
            try
            {
                lobjRespuesta = gobjCountryRegionAD.delCountryRegion_ENT(((CountryRegion)pCountryRegion));
            }
            catch (Exception lEx)
            {
        ...
        public recCountryRegionsxId_Result recCountryRegionxId_PA(string pId)
        {
            ...
            try
            {
                lobjRespuesta = gobjCountryRegionAD.recCountryRegion_PA((string)pId);
            }
            catch (Exception lEX)
            {
