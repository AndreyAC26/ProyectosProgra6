...
namespace AccesoDatos
{
    ...
    public partial class AWEntidades : DbContext
    {
        ...
        public virtual int PA_delSalesReason(Nullable<int> salesReasonID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PA_delSalesReason", salesReasonIDParameter);
        }
    
        public virtual int PA_insSalesReason(string nombre, string reasonType, Nullable<System.DateTime> modifiedDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PA_insSalesReason", nombreParameter, reasonTypeParameter, modifiedDateParameter);
        }
    
        public virtual int PA_modSalesReason(Nullable<int> salesReasonID, string nombre, string reasonType, Nullable<System.DateTime> modifiedDate)
        {
            var salesReasonIDParameter = salesReasonID.HasValue ?
                new ObjectParameter("SalesReasonID", salesReasonID) :
                new ObjectParameter("SalesReasonID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PA_modSalesReason", salesReasonIDParameter, nombreParameter, reasonTypeParameter, modifiedDateParameter);
        }
    
        public virtual ObjectResult<PA_recSalesReason_Result> PA_recSalesReason()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PA_recSalesReason_Result>("PA_recSalesReason");
        }
    
        public virtual ObjectResult<PA_recSalesReasonXId_Result> PA_recSalesReasonXId(Nullable<short> salesReasonID)
        {
            var salesReasonIDParameter = salesReasonID.HasValue ?
                new ObjectParameter("SalesReasonID", salesReasonID) :
                new ObjectParameter("SalesReasonID", typeof(short));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PA_recSalesReasonXId_Result>("PA_recSalesReasonXId", salesReasonIDParameter);
        }
